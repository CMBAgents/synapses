...
# Default configuration - Production server
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CMB Agent MCP Server (Production)")
    ...
    print(f"Starting CMB Agent MCP Server (Production) with base URL: {client.base_url}")
