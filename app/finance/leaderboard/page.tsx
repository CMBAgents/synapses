          ...
          <FadeIn>
            ...
            <div className="flex items-center justify-between mb-4 sm:mb-6 md:mb-8">
              ...
              <div className="text-center flex-1 mx-2 sm:mx-4">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-jersey text-white">
                  <span className="hidden sm:inline">Finance & Trading Libraries</span>
                  <span className="sm:hidden">Finance Libraries</span>
                </h1>
              </div>
            ...
            <div className="text-center mb-4 sm:mb-6 md:mb-8">
              <p className="text-sm sm:text-base md:text-lg mb-2 sm:mb-4 max-w-2xl mx-auto italic font-semibold text-muted font-inter">
                <span className="hidden sm:inline">Criteria: Number of stars on GitHub, Keywords: finance & trading</span>
                <span className="sm:hidden">Top finance libraries by GitHub stars</span>
              </p>
